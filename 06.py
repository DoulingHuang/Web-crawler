...
def search_104_tocsv(word, total_page):
    ...
    while page <= total_page:
        url = 'https://www.104.com.tw/jobs/search/?ro=0&kwop=7&keyword={}&order=12&asc=0&page=2&mode=s&jobsource=2018indexpoc'.format(
            word)
        headers = {
...
def main():
    ...
    page = sys.argv[2]
    # 將資料匯出成csv檔
    search_104_tocsv(str('資料分析'), int('5')).to_csv('./104_search_result.csv')
